...
export const ErrorCodes = {
  ...
  AGENT_ALREADY_RUNNING: { httpStatus: 409, message: 'Agent is already running' },
  ...
  AGENT_BUSY: { httpStatus: 409, message: 'Agent is processing another request' },
  ...
  SPAWN_INVALID_CONFIG: { httpStatus: 400, message: 'Invalid spawn configuration' },
  SPAWN_DRIVER_UNAVAILABLE: { httpStatus: 503, message: 'Requested driver unavailable' },

  // Driver
  DRIVER_NOT_FOUND: { httpStatus: 400, message: 'Unknown driver type' },
  DRIVER_INIT_FAILED: { httpStatus: 500, message: 'Driver failed to initialize' },
  DRIVER_COMMUNICATION_ERROR: { httpStatus: 502, message: 'Driver communication error' },
  DRIVER_PROTOCOL_ERROR: { httpStatus: 502, message: 'Driver protocol error' },

  // WebSocket
  WS_CONNECTION_FAILED: { httpStatus: 502, message: 'WebSocket connection failed' },
  WS_AUTHENTICATION_REQUIRED: { httpStatus: 401, message: 'WebSocket authentication required' },
  WS_SUBSCRIPTION_DENIED: { httpStatus: 403, message: 'WebSocket subscription denied' },
  WS_CURSOR_EXPIRED: { httpStatus: 410, message: 'WebSocket cursor expired' },
  WS_RATE_LIMITED: { httpStatus: 429, message: 'WebSocket rate limit exceeded' },

  // Authentication / authorization
  AUTH_TOKEN_INVALID: { httpStatus: 401, message: 'Authentication token invalid' },
  AUTH_TOKEN_EXPIRED: { httpStatus: 401, message: 'Authentication token expired' },
  ...
  RATE_CONCURRENT_LIMIT: { httpStatus: 429, message: 'Concurrent operation limit exceeded' },
  ...
  NO_HEALTHY_ACCOUNTS: { httpStatus: 503, message: 'No healthy accounts available' },
  BYOA_REQUIRED: { httpStatus: 412, message: 'BYOA required before assignment' },
  EMAIL_NOT_VERIFIED: { httpStatus: 412, message: 'Email verification required' },

  // Provisioning
  PROVISIONING_NOT_FOUND: { httpStatus: 404, message: 'Provisioning request not found' },
  PROVISIONING_INVALID_TRANSITION: { httpStatus: 409, message: 'Invalid provisioning state transition' },
  PROVISIONING_NOT_VERIFIED: { httpStatus: 412, message: 'Provisioning not verified' },
  PROVISIONING_ASSIGN_BLOCKED: { httpStatus: 409, message: 'Provisioning assignment blocked' },
  ...
  CHECKPOINT_CORRUPTED: { httpStatus: 422, message: 'Checkpoint data corrupted' },
  RESTORE_IN_PROGRESS: { httpStatus: 409, message: 'Restore already in progress' },
  ...
  CIRCULAR_DEPENDENCY: { httpStatus: 422, message: 'Circular dependency detected' },
  ...
  // Daemon
  DAEMON_NOT_RUNNING: { httpStatus: 503, message: 'Required daemon not running' },
  ...
  MISSING_REQUIRED_FIELD: { httpStatus: 400, message: 'Required field missing' },
  ...
  // Fleet / utilities
  FLEET_REPO_NOT_FOUND: { httpStatus: 404, message: 'Fleet repository not found' },
  FLEET_SYNC_IN_PROGRESS: { httpStatus: 409, message: 'Fleet sync already in progress' },
  SWEEP_NOT_FOUND: { httpStatus: 404, message: 'Agent sweep not found' },
  SWEEP_APPROVAL_REQUIRED: { httpStatus: 202, message: 'Sweep approval required' },
  UTILITY_NOT_FOUND: { httpStatus: 404, message: 'Utility not found' },
  UTILITY_INSTALL_FAILED: { httpStatus: 500, message: 'Utility install failed' },
  ...
  SYSTEM_RESOURCE_EXHAUSTED: { httpStatus: 503, message: 'System resources exhausted' },
