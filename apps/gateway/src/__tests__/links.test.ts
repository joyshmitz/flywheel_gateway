...
describe("links utilities", () => {
  ...
  describe("checkpointLinks", () => {
    test("generates full checkpoint links", () => {
      ...
      expect(links.restore).toBe("https://api.example.com/sessions/sess_456/checkpoints/chk_123/restore");
      expect(links.export).toBe("https://api.example.com/sessions/sess_456/checkpoints/chk_123/export");
