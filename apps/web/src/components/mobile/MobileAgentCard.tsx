...
import { memo, useCallback, useState, type TouchEvent } from 'react';
import { Bot, ChevronDown, ChevronUp, Play, Pause, RefreshCw, Trash2 } from 'lucide-react';
import { useMobileGestures, useSwipeToDismiss } from '../../hooks/useMobileGestures';
